...
public class Food {
	...
	TreeMap<String, NutritionalElement> rawMaterialsTree = new TreeMap<>();
	TreeMap<String, NutritionalElement> productsTree = new TreeMap<>();
	TreeMap<String, NutritionalElement> recipeTree = new TreeMap<>();
	...
	public void defineRawMaterial(String name,
		...
		rawMaterialsTree.put(rm.getName(), rm);
	}
	...
	public Collection<NutritionalElement> rawMaterials(){
		return rawMaterialsTree.values();
	}
	...
	public NutritionalElement getRawMaterial(String name){
		return rawMaterialsTree.get(name);
	}
	...
	public NutritionalElement getRecipe(String name){		
		return recipeTree.get(name);
	}
	
	public void addRecipe(Recipe r) {
		recipeTree.put(r.getName(), r);
	}
